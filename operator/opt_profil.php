...
<head>
    <title>Sewa Stadion || Halaman Operator</title>
    ...
    <link href="../admin/assets/vendors/datatables.net-fixedheader-bs/css/fixedHeader.bootstrap.min.css"
        rel="stylesheet">
...
if($_GET['lap']=="delete"){
    ...
    <div class="container-fluid w3-content" style="max-width:1400px;margin-top:60px">
            ...
            <div class="modal-dialog">
                <div class="modal-content" style="margin-top:100px;">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" style="text-align:center;">Anda yakin akan menghapus data Sewa Stadion
                            ini ?</h4>
                    </div>
        ...
        <div class="w3-row">
            ...
            <div class="w3-col m3">
                ...
                <div class="w3-card-2 w3-round w3-white">
                    <div class="w3-container">
                        <br>
                        <p class="w3-center"><img src="assets/foto_opt/<?php echo $sql_sel['foto']; ?>"
                                class="w3-circle" style="height:106px;width:106px" alt="Avatar"></p> <br>
                        ...
                        <p><i
                                class="fa fa-home fa-fw w3-margin-right w3-text-theme"></i><?php echo $sql_sel['nama_futsal']; ?>
                        </p>
                        <p><i
                                class="fa fa-user fa-fw w3-margin-right w3-text-theme"></i><?php echo $sql_sel['username']; ?>
                        </p>
                    </div>
                </div>
                <br>
                ...
                <div class="w3-card-2 w3-round">
                    <div class="w3-accordion w3-white">
                        ...
                        <div id="Demo1" class="w3-accordion-content w3-container">
                            <a href="opt_profil.php">Sewa Stadion</a>
			...
			?>
                                <div class="w3-half">
                                    <img src="assets/foto_lap/<?php echo $c['foto']; ?>" style="width:100%"
					  ...
					  $string .= $karakter[$pos];
                        ...
                        <form class="form-horizontal form-label-left" method="post">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Kode Booking
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nama Pemesan
                                    <span class="required"></span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="nama" required="required"
                                        class="form-control col-md-7 col-xs-12" value="">
                                    <input type="hidden" name="kode" required="required"
                                        class="form-control col-md-7 col-xs-12" value="<?php echo $nextID2; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">No Sewa
                                    Stadion<span class="required"></span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control form-control col-md-4 col-xs-6" name="no_lap1"
                                        id="no_lap1">
                                        <?php 
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Harga Per
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-4">
                                    <select class="form-control form-control col-md-4 col-xs-6" name="jam_mulai"
                                        id="sel1">
                                        <!-- <option>00:00</option>
                                <option>01:00</option>
                                <option>02:00</option>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-7 col-sm-7 col-xs-12" for="last-name"><span
                                        class="required"></span>
                                </label>
        ...
        <div class="w3-row-padding" style="margin:0 -16px">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    Tabel Sewa Stadion&nbsp;<a class="btn btn-success btn-sm" data-toggle="modal"
                        data-target="#myModal"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
                </div>
                        ...
                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                <?php
											...
											?>
                                <tr>
                                    <td><img src="assets/foto_lap/<?php echo $sql_res['foto']; ?>" width="30"
                                            height="30"></td>
                                    ...
                                    <td class="center"><?php
											...
											//if($qry > 0){
											 ...
											 ?></td>
                                    <td class="center">
                                        <a href="#" class='open_modal btn btn-primary btn-xs'
                                            id='<?php echo $sql_res['id_lap']; ?>'><span
                                                class="glyphicon glyphicon-edit"></span> Edit</a>&nbsp
                                        <a href="#"
                                            onClick="confirm_modal('lap_pro_del.php?&id_lap=<?php echo $sql_res['id_lap']; ?>');"
