        ...
        <div class="modal-body">
            ...
            <form class="form-horizontal" name="modal_popup" action="opt_pro_bayar.php" method="post"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="id_book" placeholder="Kode Lapangan"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="jumlah_harga" placeholder="Kode Lapangan"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="bayar" placeholder="Kurang <?php echo $sisa; ?>"
                            value="">
                    </div>
                </div>
                <div class="row">
