    ...
    <div class="modal-dialog modal-md">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Masuk Sewa Stadion</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-9">
                        <h5>Masuk sebagai Penyewa
                        </h5>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-3"></div>
                    <div class="col-sm-9"><button type="submit" class="btn btn-success" data-toggle="modal"
                            data-target="#myModal" data-dismiss="modal"><span
                                class="glyphicon glyphicon-user"></span>&nbsp; Member</button></div>
                </div>
                <br>
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-9">
                        <p>
                            Atau masuk dengan akun Operator Sewa Stadion Anda
                        </p>
                    </div>
                </div>
                <form class="form-horizontal" method="post" action="">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="username" id="pwd"
