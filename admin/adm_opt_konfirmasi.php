                 ...
                 <div class="x_panel">
                     ...
                     <div class="x_content">
						...
						?>
                                             <tr>
                                                 <td><img align="middle"
                                                         src="../operator/assets/foto_opt/<?php echo $sel['foto']; ?>"
                                                 ...
                                                 <td><a href="adm_opt_konfirmasi.php?url=confirm&&username=<?php echo $sel['username']; ?>"
                                                         class="btn btn-primary btn-xs"><i class="fa fa-check"></i>
                                                         Aktifkan </a><a
                                                         href="adm_opt_konfirmasi.php?url=hapus&&username=<?php echo $sel['username']; ?>"
                                                         class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Hapus
                                                     </a></td>
                                             </tr>
                                             <?php } ?>
                                         </tbody>
