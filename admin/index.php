...
<head>
    ...
    <title>Sewa Stadion || Administration </title>
            ...
            <div class="col-md-3 left_col menu_fixed">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="index.php" class="site_title"><img src="../assets/images/pemkab.png"
                                style="width:30px; height:30px;"> <span>Sewa Stadion</span></a>
                    </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-th-list"></i> Data Anggota <span
                                    ...
                                    <ul class="nav child_menu">
                                        ...
                                        <li><a href="index.php?url=lap">Stadion</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-edit"></i> Konfirmasi <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                ...
                                <li><a><i class="fa fa-desktop"></i> Data Pemesanan <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                ...
                                <li><a><i class="fa fa-pie-chart"></i> Laporan <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                ...
                                <ul class="dropdown-menu dropdown-usermenu pull-right">
                                    ...
                                    <li><a href="adm_logout.php"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li role="presentation" class="dropdown">
                                ...
                                <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                                    <li>
                                        <a>
                                            <span class="image"><img src="images/<?php echo $sel['foto']; ?>"
