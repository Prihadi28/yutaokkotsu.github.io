        ...
        <?php
			if(isset($_POST['kirim'])){
				...
				//format email yang akan dikirim ke email pemesan
					$message = "Pembayaran dengan kode booking $_POST[id_book] telah Admin konfirmasi. Terimakasih telah melakukan pembayaran. Silahkan bermain dengan menunjukkan email Anda pada operator tempat Sewa Stadion terlebih dahulu.";  
