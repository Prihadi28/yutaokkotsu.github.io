          ...
          <tr>
             ...
             <td class="center">
				...
				if(isset($_POST['kirim'])){
					...
					$email = $member['email'];
					$to = $email;
					$subject = "Pembayaran dengan kode booking $sql_res[id_book] telah Admin konfirmasi. Terimakasih telah melakukan pembayaran. Silahkan bermain dengan menunjukkan email Anda pada operator tempat Sewa Stadion terlebih dahulu.";
