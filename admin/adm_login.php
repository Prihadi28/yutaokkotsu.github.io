...
<head>
    ...
    <title>Login Administration | Sewa Stadion</title>
            ...
            <div class="animate form login_form">
                <section class="login_content">
                    <form action="" method="post">
                        ...
                        <div>
                            <input type="text" class="form-control" placeholder="Username Or Email" name="id"
                                required="" />
                        </div>
                        <div>
                        ...
                        <div>
                            <button type="submit" class="btn btn-success" name="adm"><span
                        ...
                        <div class="separator">
                            ...
                            <div>
                                <h1><img src="../assets/images/pemkab.png" style="width:25px; height:25px;"> Sewa
                                    <font color="#6fcb44">Stadion</font>
                                </h1>
                                <p>Sewa Stadion By PKL UNUGIRI</p>
