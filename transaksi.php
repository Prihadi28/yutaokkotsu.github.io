...
<head>
    ...
    <title>Sewa Stadion || Pemesanan</title>
    <!-- Custom Theme Style -->
  ...
  include "navbar.php";
    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">Pemesanan Sewa Stadion</div>
            <div class="panel-body">
                <h4>Pesan Sewa Stadion Anda Dan Segera Lakukan Pembayaran </h4>
                <hr>
		  ...
		  // membuat kode urut otomatis sebagai ID booking
                ...
                <form class="form-horizontal form-label-left" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="hidden" id="first-name" required="required" name="username"
                                ...
                                value="<?php echo $sql_sel['username_member']; ?>" readonly>
                            <input type="hidden" id="id_lap" name="id_lap" required="required"
                                class="form-control col-md-7 col-xs-12" value="<?php echo $pilih['id_lap']; ?>"
                                readonly>
                        </div>
                    </div>
                    <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Harga Per 3 Jam<span
                                class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="last-name" name="last-name" required="required"
                                class="form-control col-md-7 col-xs-12" value="Rp. <?php echo $pilih['harga']; ?>,00"
                                readonly>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div id="gender" class="btn-group" data-toggle="buttons">
                                <label class="btn btn-default" data-toggle-class="btn-primary"
                                    ...
                                    <input type="radio" name="jenis_bayar" required value="cod"> &nbsp; Tunai &nbsp;
                                </label>
                                <label class="btn btn-primary" data-toggle-class="btn-primary"
                                    data-toggle-passive-class="btn-default">
                                    <input type="radio" name="jenis_bayar" required value="transfer">Bayar Bank
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Tanggal Sewa<span
                                class="required"></span>
                        </label>
            ...
            <?php 
						...
						if(strtotime($tgljam)-strtotime($tanggaljam) > 43200){ //jika main lebih dari 12 jam
							$bayarakhir= date('Y-m-d H:i:s', time()+60*60*12*14); // maka bayar akhir 6 jam dari waktu pesan
							} else { // jika tidak
							$bayarakhir= date('Y-m-d H:i:s', time()+60*60*12*14); // maka bayar akhir 3 jam dari waktu pesan
								}
              ...
              echo '<script>
              Swal.fire({
                text: "Jam Yang Anda Pilih Telah Di Sewa Orang Lain.",
                icon: "error",
                confirmButtonText: "OK"
						...
						}elseif($tanggal_main == $tanggal && $jam_mulai < $jam){ // cek Tanggal Sewa = tanggal sekarang dan jam mulai kurang dari jam sekarang
              echo '<script>
              Swal.fire({
                text: "Jam Mulai Kadaluarsa.",
                icon: "error",
                confirmButtonText: "OK"
              });
           </script>';
						}elseif($tanggal_main < $tanggal){ // cek Tanggal Sewa kurang dari tanggal sekarang
              echo '<script>
              Swal.fire({
...
<?php 
    ...
    echo "<script> alert(\"Silakan Login Sebagai Penyewa\"); window.location = \"index.php\" </script>";
  }
?>