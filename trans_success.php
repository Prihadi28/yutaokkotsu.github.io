        ...
        <div class="panel panel-default">
          ...
          <hr>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                              <h4>Tanggal Sewa &nbsp;: <?php echo $s['tgl_main']; ?> </h4>
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name"><span class="required"></span>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                              <h3 align="center">Selamat bermain dengan menunjukkan halaman ini atau dengan menunjukkan bukti email yang telah dikirim ke email Anda kepada Operator tempat Sewa Stadion </h3>
                            </div>
                          </div>
