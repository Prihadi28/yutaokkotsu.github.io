...
<head>
    <title>Sewa Stadion || Halaman Member</title>
    <meta charset="utf-8">
            ...
            <div class="w3-col m3">
                ...
                <div class="w3-card-2 w3-round w3-white">
                    <div class="w3-container">
                        <br>
                        <p class="w3-center"><img src="assets/foto_member/<?php echo $sql_sel['foto']; ?>"
                        ...
                        <p><i
                                class="fa fa-home fa-fw w3-margin-right w3-text-theme"></i><?php echo $sql_sel['email']; ?>
                        </p>
                        <p><i
                                class="fa fa-user fa-fw w3-margin-right w3-text-theme"></i><?php echo $sql_sel['username_member']; ?>
                        </p>
                    </div>
                </div>
                <br>
                ...
                <div class="w3-card-2 w3-round">
                    <div class="w3-accordion w3-white">
                        ...
                        <div id="Demo3" class="w3-accordion-content w3-container">
                            ...
                            <a href="member_profil.php?url=bay_offline"> Bayar Offline (Tunai)</a>
                        </div>
